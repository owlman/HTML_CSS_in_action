...
- **委托方**：凌雪冰熊股份有限公司互联网部门
- **项目资料**：
  - **图片资料**：主要包括品牌的Logo图和吉祥物照片各一张，产品与门店的样图各三张以及一些图标（如图2-1所示）。  
    ![pic](./img/2-1.png)  
    **图1-1**：凌雪冰熊网站的图片资料
...
1. 首先，我们需要使用一个被称之为“轮播”的Bootstrap组件来展示凌雪冰熊饮料店在北上广三地的代表性店面，为此，读者需要回到`index.htm`文件中，找到`<!-- 此处将设置一个组件轮播连锁店的各地店面 -->`这一行注释所在的位置，并将其替换为以下代码。
...
请根据本章项目【任务书】要求，基于Bootstrap框架来完成这个网页设计任务。
