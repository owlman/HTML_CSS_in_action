...
在经过了上一章的项目实践之后，读者想必已经对在网页设计工作中会用到的两门计算机标记语言，HTML和CSS有了一个基本的了解。接下来，本书将根据要实践的项目场景来分门别类地介绍这两门语言及其相关框架的具体应用。在本章要实践的项目中，我们的主要任务是完成企业类网站首页的整体设计，目的是为整个网站建立统一的布局风格和外观样式。下面就先来介绍一下完成该项目任务所需要掌握的知识点与工具。当然了，如果读者认为自己已经掌握了这部份知识，可自行跳过本节内容，直接进入本章项目的【工作实施与交付】环节。
