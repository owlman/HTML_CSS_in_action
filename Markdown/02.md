...
在本章，笔者将会以一家名为“凌雪冰熊”的连锁饮料店的需求为例来演示如何完成企业网站的首页设计，以便向公众展示该饮料店的品牌信息，以便建立起人们对这家连锁品牌的第一印象。同时，该项目也会为该企业网站后续要设计的新闻活动、申请加盟、留言板等页面设置好统一的布局风格与配色方案，并预留整合这些页面的导航链接。通过本章项目的实践，读者将会初步了解设计一个企业展示类页面所要执行的基本步骤，以及执行这些步骤所需的基本技术与相关工具。总而言之，在阅读完本章之后，我们希望读者能够：
